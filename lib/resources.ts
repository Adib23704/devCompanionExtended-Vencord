...
export const resourceStore = new Map<string, { mimeType: string; text: string; createdAt: number; }>();
...
export function updateResource(id: string, text: string, mimeType: string): void {
...
export function buildResourceResponse(data: unknown, mimeType = "application/json", previewLength = 800): ToolCallResult {
...
export function buildErrorResponse(message: string, where?: string): ToolCallResult {
...
export function buildToolResponse(result: unknown, args?: Record<string, unknown>): ToolCallResult {
