...
export const MCP_TOOLS: MCPTool[] = [
  {
    name: "module",
    description:
      "Unified webpack module operations: find, extract, exports, context, diff, relationships, size, ids, stats, explain, findStrings.",
    inputSchema: {
      type: "object",
      properties: {
        action: {
          ...
          description:
            "find=search modules, extract=get source, exports=list exports, context=summary/snippets, diff=patched vs original, deps/relationships=module graph, size=module size, ids=list module ids, stats=webpack summary",
        },
        ...
        props: {
          type: "array",
          items: { type: "string" },
          description: "Find by export props",
        },
        code: {
          type: "array",
          items: { type: "string" },
          description: "Find by code snippets",
        },
        displayName: {
          type: "string",
          description: "Find by displayName (components)",
        },
        className: {
          type: "string",
          description: "Find by CSS module class fragment",
        },
        exportName: {
          type: "string",
          description: "Find by export name (prop match)",
        },
        exportValue: {
          type: "string",
          description: "Find by export value (string search)",
        },
        pattern: {
          type: "string",
  ...
  },
  {
    name: "store",
    description:
      "Unified Flux store operations: find, list, state, call, diff, subscriptions, methods.",
    inputSchema: {
      type: "object",
      properties: {
        action: {
        ...
        args: {
          type: "array",
          items: {},
          description: "Arguments for method call",
        },
        filter: {
          type: "string",
          description: "Filter store names by substring",
        },
  ...
  },
  {
    name: "component",
    description:
      "Component operations: find by code, inspect from DOM, component tree.",
    inputSchema: {
      type: "object",
      properties: {
        ...
        code: {
          type: "array",
          items: { type: "string" },
          description: "Code snippets for find",
        },
        selector: {
          type: "string",
          description: "CSS selector for inspect/tree",
        },
        isRegex: { type: "boolean", default: false },
        limit: { type: "number", default: 20 },
  ...
  },
  {
    name: "intl",
    description:
      "Unified intl operations: hash, reverse, search, scan, targets.",
    inputSchema: {
      type: "object",
      properties: {
        action: {
          type: "string",
          enum: ["hash", "reverse", "search", "scan", "targets"],
        },
        key: {
          type: "string",
          description: "Readable intl key (e.g. USER_SETTINGS)",
        },
  ...
  },
  {
    name: "patch",
    description:
      "Unified patch operations: test, lint, overlap, unique, analyze, plugin, suggest.",
    inputSchema: {
      type: "object",
      properties: {
        action: {
        ...
        match: {
          type: "string",
          description:
            "Match regex for test (optional if replacements provided)",
        },
        replace: {
          type: "string",
          description: "Replacement string for test preview",
        },
        replacements: {
          type: "array",
          items: {
        ...
        moduleId: {
          type: "number",
          description:
            "Optional module id to generate anchor suggestions for lint",
        },
        brokenFind: {
          type: "string",
          description: "Broken find string for suggest",
        },
        pluginName: {
          type: "string",
          description: "Plugin name for analyze/plugin",
        },
        limit: { type: "number", default: 20 },
        summary: { type: "boolean", default: false },
        maxItems: { type: "number" },
  ...
  },
  {
    name: "dom",
    description:
      "Unified DOM operations: inspect, query, styles, modify, tree, classes, text, path, snapshot.",
    inputSchema: {
      type: "object",
      properties: {
        action: {
  ...
  },
  {
    name: "discord",
    description:
      "Discord context and APIs: context, ready, waitForIpc, REST, snowflake, endpoints, common, stores, memory, performance, enum.",
    inputSchema: {
      type: "object",
      properties: {
        action: {
        ...
        timeoutMs: {
          type: "number",
          description: "Ready wait timeout in ms (action=ready/waitForIpc)",
        },
        intervalMs: {
          type: "number",
          description: "Ready poll interval in ms (action=ready/waitForIpc)",
        },
        warmupMs: {
          type: "number",
          description: "Warmup delay before polling (action=waitForIpc)",
        },
        summary: { type: "boolean", default: false },
        maxItems: { type: "number" },
        maxChars: { type: "number" },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        action: {
          type: "string",
          enum: ["start", "get", "stop", "events", "status", "clear"],
        },
  ...
  },
  {
    name: "plugin",
    description:
      "Plugin operations: list, info, patches, enable/disable, toggle, settings, setSetting.",
    inputSchema: {
      type: "object",
      properties: {
        action: {
        ...
        pluginName: {
          type: "string",
          description: "Plugin name for patches/toggle",
        },
        ...
        values: {
          type: "object",
          description: "Settings values for settings action",
        },
        summary: { type: "boolean", default: false },
        maxItems: { type: "number" },
        maxChars: { type: "number" },
  ...
  },
  {
    name: "search",
    description:
      "Unified search: literal/regex/pattern/props/code/store/component/moduleId, extract, or context.",
    inputSchema: {
      type: "object",
      properties: {
        action: {
        ...
        pattern: {
          type: "string",
          description: "Search pattern or comma-separated props/code",
        },
        isRegex: { type: "boolean", default: false },
        preset: {
          type: "string",
        ...
        kind: {
          type: "string",
          enum: ["literal", "regex", "pattern", "props", "code"],
        },
  ...
  },
  {
    name: "testPatch",
    description:
      "Test if a patch works against current Discord. Validates find uniqueness and match patterns.",
    inputSchema: {
      type: "object",
      properties: {
        find: { type: "string" },
        ...
        previewMode: {
          type: "string",
          enum: ["compact", "full", "context-only"],
          default: "compact",
        },
        contextLines: { type: "number", default: 2 },
  ...
  },
  {
    name: "intercept",
    description:
      "Intercept function calls and capture arguments/return values.",
    inputSchema: {
      type: "object",
      properties: {
        ...
        path: {
          type: "string",
          description: "Dot path to function (e.g. default.render)",
        },
  ...
  },
  {
    name: "reloadDiscord",
    description:
      "Reload the Discord client. Useful after making changes that require a reload.",
    inputSchema: {
      type: "object",
      properties: {
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        parallelism: {
          type: "number",
          description: "Max concurrent tool calls (default 4, max 10)",
        },
        timeoutMs: {
          type: "number",
          description:
            "Default per-tool timeout in ms (default 60000, max 120000)",
        },
        stream: {
          type: "boolean",
          description:
            "Return immediately and stream results via read_resource",
          default: false,
        },
        requests: {
          type: "array",
          items: {
            ...
            properties: {
              ...
              timeoutMs: {
                type: "number",
                description: "Override timeout for this request in ms",
              },
            },
            required: ["tool"],
          },
